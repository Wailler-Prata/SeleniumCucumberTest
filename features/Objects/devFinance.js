...
class DevFinanceHome extends Webpage{
    ...
    cssSelectorDescriptionOfEntranceInRegisterFieldset = By.css('#description')
    cssSelectorAmountOfEntranceInRegisterFieldset = By.css('#amount')
    cssSelectorDateOfEntranceInRegisterFieldset = By.css('#date')
    ...
    async registerEntrance(description, amount, date){        
        ...
        await this.findElement(this.cssSelectorDescriptionOfEntranceInRegisterFieldset)
            .then(element=>{ element.sendKeys(description)})
        await this.findElement(this.cssSelectorAmountOfEntranceInRegisterFieldset)
            .then(element=>{ element.sendKeys(amount)})
        await this.findElement(this.cssSelectorDateOfEntranceInRegisterFieldset)
